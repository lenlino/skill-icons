...
Use this tool to easily add skill icons to your profile.
...
We welcome icon contributions!

**Icons must be 256x256 in size and maintain consistency with other icons.**

You can easily create icons with a similar style using our [Icon Creation Tool](https://tools.lenlino.com/icon-converter). Please feel free to use it.

Feel free to open a pull request with your icon additions!

## Credits

This project is forked from [tandpfun/skill-icons](https://github.com/tandpfun/skill-icons). Thank you for creating this amazing tool!
